...
class Doctor extends CI_Controller
{
	...
	/******CONTACT DOCTOR LIST*****/
	function contact_patient($param1 = '', $param2 = '', $param3 = '')
	{
		if ($this->session->userdata('doctor_login') != 1)
			redirect(base_url() . 'index.php?login', 'refresh');
		
		$page_data['page_name']  = 'contact_patient';
		$page_data['page_title'] = get_phrase('contact_patient');
		$page_data['patients']    = $this->db->get('patient')->result_array();
	...
	function contact_patient2($param1 = '', $param2 = '', $param3 = '')
	{
		if ($this->session->userdata('doctor_login') != 1)
			redirect(base_url() . 'index.php?login', 'refresh');
		...
		$page_data['page_name']  = 'contact_patient2';
		$page_data['page_title'] = get_phrase('contact_patient2');	
