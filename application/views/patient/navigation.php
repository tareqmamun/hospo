...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
		...
		<li class="<?php if($page_name == 'contact_doctor')echo 'dark-nav active';?>">
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?patient/contact_doctor" >
					<i class="icon-user-md icon-2x"></i>
					<span><?php echo get_phrase('contact_doctor');?></span>
				</a>
		</li>
		
		<li class="<?php if($page_name == 'rate_doctor')echo 'dark-nav active';?>">
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?patient/rate_doctor" >
					<i class="icon-user-md icon-2x"></i>
					<span><?php echo get_phrase('rate_doctor');?></span>
				</a>
		</li>		
