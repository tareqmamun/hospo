...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
        ...
        <!------appointment----->
		<li class="<?php if($page_name == 'contact_patient')echo 'dark-nav active';?>">
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?doctor/contact_patient" >
					<i class="icon-edit icon-2x"></i>
					<span><?php echo get_phrase('contact_patient');?></span>
				</a>
		</li>		
